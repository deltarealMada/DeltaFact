    ...
    public partial class f_gesfact : Form
    {
        ...
        private void chargerfacture(string temprech = "")
        {
            ...
            sqlfact = "select fact.numligne, fact.remarquearticle, " +
                ...
                "prix.prix as prixunitaire, " + //prix à prendre dans table des prix
            ...
            if (tp_facture.SelectedIndex == 1) //envoyées mais non payées en totalité
            {
                if (temprech != "" || cond != "")
                {
                    sqlfact += " AND ";
                ...
                sqlfact += " fact.dateimpression is not null AND (paiement.montantpaye = 0 OR paiement.montantpaye IS NULL OR paiement.montantpaye < fact.montantapayer)";
            }
            ...
            else if(tp_facture.SelectedIndex == 2) //payées
            {
                if (temprech != "" || cond != "")
                {
                    sqlfact += " AND ";
            ...
            while (myread.Read())
            {
                ...
                if (uf.GetValue(myread, "icli") != iCli) //nouveau client
                {
                    nbrGroupFact = 0;
                    //Total
                    if (iCli != "")
                    ...
                    //
                    //lv.Groups[uf.GetValue(myread, "icli")].ListView.BackColor = Color.PaleGreen;
        ...
        */
        ...
        private void bt_modif_Click(object sender, EventArgs e)
        {
            ...
            etatfact = 1;
            chargerfacture("reffacturedeltareal = '" + numf + "'");
            
                curidcli = lv.Items[0].Group.Name;
        ...
        private void bt_ajout_Click(object sender, EventArgs e)
        {
            if (curidcli == "")
            {
                if (lv.SelectedItems.Count > 0)
                {
                    curidcli = lv.SelectedItems[0].Group.Name;
                }
                else
                {
        ...
        public void ajoutevent()
        {
            ...
            lv.Groups[curidcli].ListView.BackColor = Color.LightBlue;
        ...
        private void ajoutlignetot()
        {
            ...
            lv.Items[ind].Group = lv.Groups[curidcli];
        ...
        */
        ...
        private void bt_valider_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            chargerfacture("reffacturedeltareal = '" + reffact + "'");
        ...
        private void ajoutligneart()
        {
            ...
            else if(etatfact == 2 && ck_typesaisie.Checked == false) //plusieurs ligne, mode ajout
            {
        ...
        */
        private void bt_imprimertout_Click(object sender, EventArgs e)
        {
            ...
            if (tp_facture.SelectedIndex == 1) //envoyées mais non payées en totalité
            {
                ...
                f.cond += " fact.dateimpression is not null AND (paiement.montantpaye = 0 OR paiement.montantpaye IS NULL or paiement.montantpaye < fact.montantapayer)";
            }
            else if (tp_facture.SelectedIndex == 0) //saisies non encore envoyées
            {
                if (cond != "")
